...
DEFAULT_APP_SCRIPT = f"{PROJECT_ROOT}/ARTC_iot_use_cases_lab_07_July/iot_uc2_model/run_app.py"
RUNTIME_IMAGE = (
...
def main() -> None:
    ...
    try:
        ...
        print('       -d \'{"machine_id":"BAT-01","process_type":"battery_assembly",')
        print('             "temperature":31.9,"voltage":3.70}\'')
