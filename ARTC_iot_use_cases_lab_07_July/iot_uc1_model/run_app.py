...
Installs dependencies and starts the FastAPI app via uvicorn.
Run locally or as the CAI Application startup script.
...
DEFAULT_APP_DIR = f"{PROJECT_ROOT}/extra_materials/iot_use_cases/iot_uc1_model"
